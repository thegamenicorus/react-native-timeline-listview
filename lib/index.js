...
export default class Timeline extends Component {
  ...
  _renderEvent(rowData, sectionID, rowID){
    ...
    return (
      <View style={[styles.details, opStyle]} onLayout={(evt)=> { if(!this.state.x && !this.state.width){var {x,width} = evt.nativeEvent.layout;console.log(x,width);this.setState({x, width})}}}>
