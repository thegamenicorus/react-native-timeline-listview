  ...
  _renderRow(rowData, sectionID, rowID) {
    ...
    let content = (
      <View style={[styles.rowContainer, this.props.rowContainerStyle]}>
        ...
        <TouchableOpacity disabled={this.props.onTimelinePress == null} style={[styles.details, {borderColor: lineColor, borderLeftWidth: lineWidth}, this.props.detailContainerStyle]}
