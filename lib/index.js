...
export default class Timeline extends Component {
  ...
  _renderEvent(rowData, sectionID, rowID){
    ...
    return (
      <View style={[styles.details, opStyle, eventStyle]} onLayout={(evt)=> { if(!this.state.x && !this.state.width){var {x,width} = evt.nativeEvent.layout;this.setState({x, width})}}}>
