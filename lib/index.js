...
import {Animated, Easing, Image, ListView, StyleSheet, Text, TouchableOpacity, View,} from 'react-native'
...
export default class Timeline extends Component {
    constructor(props, context) {
        ...
        this.renderInnerCircle = (this.props.renderInnerCircle?this.props.renderInnerCircle:this._renderInnerCircle).bind(this)
    ...
    _renderCircle(rowData, sectionID, rowID){
        ...
        var innerCircle = this.renderInnerCircle(rowData, circleSize);
        return (
